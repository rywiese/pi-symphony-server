...
# 27 "src/react/lwt_react.cppo.ml"
      (fun x -> ignore (Sys.opaque_identity r); x)
      
# 29 "src/react/lwt_react.cppo.ml"
      event
...
# 280 "src/react/lwt_react.cppo.ml"
      (fun x -> ignore (Sys.opaque_identity r); x)
      
# 282 "src/react/lwt_react.cppo.ml"
      signal
