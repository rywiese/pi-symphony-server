...
module M =
  struct
    ...
    let pmod_functor ~loc  x0 x1 x2 =
      {
        pmod_attributes = [];
        pmod_loc = loc;
        pmod_desc = (Pmod_functor (x0, x1, x2))
      }
    ...
    let pmty_functor ~loc  x0 x1 x2 =
      {
        pmty_attributes = [];
        pmty_loc = loc;
        pmty_desc = (Pmty_functor (x0, x1, x2))
      }
