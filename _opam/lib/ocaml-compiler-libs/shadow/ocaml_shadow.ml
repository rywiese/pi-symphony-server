...
module Available_regs = Do_not_use_directly [@@deprecated "Accessing this module directly is deprecated, use Ocaml_optcomp.Available_regs instead"]
...
module Spacetime_profiling = Do_not_use_directly [@@deprecated "Accessing this module directly is deprecated, use Ocaml_optcomp.Spacetime_profiling instead"]
